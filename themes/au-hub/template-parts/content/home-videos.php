...
<div class="row">
    ...
    <div class="col-md-6"> 
        ...
        if( $videos_featured_post ): 

            $post = $videos_featured_post;
            setup_postdata( $post ); 

            ?>

            <div id="video-featured" class="featured featured-md">
    ...
    <?php
        $featured_posts = array(get_field('videos_featured_post',$post->ID)->ID);
        $args = array(
            'post_type'      => 'post',
            'posts_per_page' => '4',
