...
<div id="page">
        ...
        <header id="main-header">
            ...
            <div id="current-title">
                <?php if ( !is_front_page() ) : ?>
                    <a href="<?php echo get_home_url(); ?>"><span class="blog-name"><?php bloginfo('name'); ?></span></a>
                <?php endif; ?>
                ...
                <?php elseif( is_search() ):; ?>
                    <a href="<?php echo get_home_url(); ?>"><span class="page-name">Search Results</span></a>
                ...
                <ul class="nav-panel-actions">
                    <li id="notifications-trigger">
                         <a href="#notifications" aria-expanded="false" class="nav-panel-toggle" aria-label="View notification and deadlines" role="button" aria-controls="notifications">
                            <div class="hamburger hamburger hamburger--slider js-hamburger is-active" tabindex="0" aria-label="Menu" role="button" aria-controls="main-navigation-container">
                    ...
                    <li id="search-trigger">
                        <a href="#site-search" aria-expanded="false" class="nav-panel-toggle" aria-label="Search AU Website" role="button" aria-controls="site-search">
                            <div class="hamburger hamburger hamburger--slider js-hamburger is-active" tabindex="0" aria-label="Menu" role="button" aria-controls="main-navigation-container">
                                <span class="hamburger-box">
                                    <span class="hamburger-inner"></span>
                                </span>
                            ...
                            <div class="nav-panel-inner">
                                <form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url( '/' ); ?>">
                                    <div><label class="screen-reader-text" for="s">Search for:</label>
                                        <input type="text" value="" placeholder="Search the AU Hub" name="s" id="s" />
                                        <input type="submit" id="searchsubmit" class="btn btn-orange" value="Search" />
                                    </div>
                                </form>
                            </div>
                        </div><!-- END #site-search -->
                    ...
                    <!--Mobile Hamburger -->
                    <li id="au-site-nav-trigger">
                        <a href="#au-site-nav-panel" aria-expanded="false" class="nav-panel-toggle" aria-label="Open Main Menu" role="button" aria-controls="au-site-nav-panel">
                        ...
                        <div id="au-site-nav-panel" class="nav-panel"></div>
                    </li><!-- END #au-site-nav-trigger -->
                </ul>
            </div>                
    ...
    <div id="content-container">
        <!--Main Navigation Position in Desktop-->
        ...
        <div id="breadcrumb">
            <div id="open-main-nav">
                <div class="hamburger hamburger hamburger--slider js-hamburger" tabindex="0" aria-label="Menu" role="button" aria-controls="main-navigation-container">
                    ...
                    <span class="nav-panel-label default">Menu</span>
                    <span class="nav-panel-label close">Close</span>
                </div>
            </div>
